    ...
    <div style="width: 100%;text-align: left;">
            ...
            <div class="row">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;">
                                                          ...
                                                          <div class="col-xs-6 col-sm-3">
                                                            <!--    <table style="width: 100%">
                                                              ...
                                                              <button type="button" onclick="cancelfilter('ProdResultSMT','SMT','Result')" class="btn btn-outline-secondary"><i class="fas fa-ban"></i>&nbspCANCEL FILTER&nbsp&nbsp</button>  
                                                              <button type="button" class="btn btn-outline-secondary" onclick="SyncToProdOutputSystem();cancelfilter('ProdResultSMT','SMT','Result')" ><i class="fas fa-sync-alt"></i>&nbspSYNC&nbsp&nbsp</button>
                                                              <button type="button" class="btn btn-outline-secondary" onclick="exportxlsx('ProdResultSMT','SMT','Result')"><i class="fas fa-file-excel"></i>&nbspEXPORT&nbsp&nbsp</button>
                                                                </div>
                                      ...
                                      <!--  <div class="col-md-3" style="padding-top: 10px; border-style: solid">
                                       ...
                                       <span><h5>Prod Result SMT</h5></span>
                                    </div>
                          </div><!-- end of row-->
