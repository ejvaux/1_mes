          ...
          <form action='#' method='POST' id="sortform">
            <div class="row">
                                                ...
                                                <tr>
                                                  ...
                                                  <td> 
                                                   ...
                                                   <input onchange='showTable("ProdResultMOLD","MOLD","Result")' id='search' type='text' name='search1' placeholder='Type anything..' class='form-control' style='font-size: 10px;'>
                                                    ...
                                                    <td>&nbsp
                                                    <button type="button" onclick="showTable('ProdResultMOLD','MOLD','Result')" class="btn btn-outline-secondary p-0 my-2 my-sm-0">&nbsp<i class="fa fa-search"></i>&nbsp</button>  
                                                  </td>
                                                      ...
                                                      <div class="row" style="padding-top: 10px;">
                                                          ...
                                                          <div class="col-xs-6 col-sm-3">
                                                            <!--    <table style="width: 100%">
                                                              ...
                                                              <button type="button" onclick="cancelfilter('ProdResultMOLD','MOLD','Result')" class="btn btn-outline-secondary"><i class="fas fa-ban"></i>&nbspCANCEL FILTER&nbsp&nbsp</button>  
                                                              <button type="button" class="btn btn-outline-secondary" onclick="SyncToProdOutputSystem();cancelfilter('ProdResultMOLD','MOLD','Result')" ><i class="fas fa-sync-alt"></i>&nbspSYNC&nbsp&nbsp</button>
                                                              <button type="button" class="btn btn-outline-secondary" onclick="exportxlsx('ProdResultMOLD','MOLD','Result')"><i class="fas fa-file-excel"></i>&nbspEXPORT&nbsp&nbsp</button>
                                                             </div>
                                      ...
                                      <div class="col-sm-3" style="padding-top: 15px; padding-right: 25px; text-align: right;">
                                       <span><h5>Prod Result MOLD</h5></span>
                                    </div>
