...
<nav class="navbar navbar-brdr navbar-expand-lg navbar-light bg-light m-0 px-2 pb-1 pt-0" style="position:fixed;width: 100%; z-index:2; ">
       ...
       <div class="dropdown-menu text-center" aria-labelledby="navbarDropdown">                  
         <div class="container dropdown-header text-left">
           ...
           <div class="row">
             <div class="col">
               <h6 class="text-left">
               <a href="#" onclick="loadtbl2('ProdPlanVsResultINJ');" style="color: black">PROD PLAN VS RESULT - <b>INJ</b></a>
               </h6>
             </div>                      
           </div>
           <div class="row">
           ...
           <div class="row">
             <div class="col">
               <h6 class="text-left">
               <a href="#" onclick="loadtbl2('ProdPlanVsResultSMT');" style="color: black">PROD PLAN VS RESULT - <b>SMT</b></a>
               </h6>
             </div>                      
           </div>
           <div class="row">
...
function showUser(){
   ...
   /*  alert(strfromobj+" "+searchobj+" "+strtoobj); */
    ...
    $.ajax({
          method:'POST',
          url:'/1_mes/_php/manuc_info/Prodplan/DataProdPlanVsResultSMT.php',
          data:
          {
              'sortfrom': strfromobj,
              'sortto': strtoobj,
...
$("#download-xlsx").click(function(){
    $("#example-table").tabulator("download", "xlsx", "ProdplanVsResultSMT.xlsx", {sheetName:"ProdPlanVsResultSMT"});
