          ...
          <form action='#' method='POST' id="sortform">
            <div class="row">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;">
                                                          ...
                                                          <div class="col-xs-6 col-sm-3">
                                                            <!--    <table style="width: 100%">
                                                              ...
                                                              <button type="button" onclick="cancelfilter('ProdResultPRINTING','PRINTING','Result')" class="btn btn-outline-secondary"><i class="fas fa-ban"></i>&nbspCANCEL FILTER&nbsp&nbsp</button>  
                                                              <button type="button" class="btn btn-outline-secondary" onclick="SyncToProdOutputSystem();cancelfilter('ProdResultPRINTING','PRINTING','Result')" ><i class="fas fa-sync-alt"></i>&nbspSYNC&nbsp&nbsp</button>
                                                              <button type="button" class="btn btn-outline-secondary" onclick="exportxlsx('ProdResultPRINTING','PRINTING','Result')"><i class="fas fa-file-excel"></i>&nbspEXPORT&nbsp&nbsp</button>
                                                            </div>
                                      ...
                                      <div class="col-sm-3" style="padding-top: 15px; padding-right: 25px; text-align: right;">
                                       <span><h5>Prod Result PRINTING</h5></span>
                                    </div>
