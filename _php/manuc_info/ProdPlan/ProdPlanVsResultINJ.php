                                              ...
                                              <table style="width: 100%">
                                                <tr>
                                                  ...
                                                  <td> 
                                                    ...
                                                    <td>&nbsp
                                                    <button type="button" onclick="showTable('ProdPlanVsResultINJ','INJ','PlanWithResult')" class="btn btn-outline-secondary p-0 my-2 my-sm-0 btn-export6">&nbsp<i class="fa fa-search"></i>&nbsp</button>  
                                                  </td>
