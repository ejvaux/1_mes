...
<div class="mod_options" style="z-index: 0;padding-top: 70px;padding-left: 15px">
    ...
    <div style="width: 100%;text-align: left;">
                                                          ...
                                                          <div class="col-12">                                                          
                                                            <div class="btn-toolbar mb-1" role="toolbar" aria-label="Toolbar with button groups">
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                  ...
                                                                  <input id='sortfrom' onchange='showTable("ProdPlanVsResultSMT","SMT","PlanWithResult")' type='date' name='sortingdatefrom' class='form-control' style='font-size: 10px'>
                                                                </div>
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                  ...
                                                                  <input id='sortto' onchange='showTable("ProdPlanVsResultSMT","SMT","PlanWithResult")' type='date' name='sortingdateto' class='form-control' style='font-size: 10px'>
                                                                </div>
         ...
         &nbsp<span style="font-size: 18px; font-weight: bold">Production Plan Vs Result SMT</span>
      <div class="cont1 p-1">
