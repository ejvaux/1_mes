                                              ...
                                              <table style="width: 100%">
                                                <tr>
                                                  ...
                                                  <td> 
                                                    ...
                                                    <input onkeypress='showTable("ProdPlanVsResultMOLD","MOLD","PlanWithResult")' id='search' type='text' name='search1' placeholder='Type anything..' class='form-control' style='font-size: 10px;'>
                                                    ...
                                                    <td>&nbsp
                                                    <button type="button" onclick="showTable('ProdPlanVsResultMOLD','MOLD','PlanWithResult')" class="btn btn-outline-secondary p-0 my-2 my-sm-0 btn-export6">&nbsp<i class="fa fa-search"></i>&nbsp</button>  
                                                  </td>
