                                                          ...
                                                          <div class="col-12">                                                          
                                                            <div class="btn-toolbar mb-1" role="toolbar" aria-label="Toolbar with button groups">
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                    ...
                                                                    <button type="button" onclick='showTable("ProdPlanVsResultSAMPLES","SAMPLES","PlanWithResult")' class="btn btn-outline-secondary btn-export6 btn-sm" style="z-index:0">&nbsp<i class="fa fa-search"></i>&nbsp</button>    </div>
                                                                </div>
