                                              ...
                                              <table style="width: 100%">
                                                <tr>
                                                  ...
                                                  <td> 
                                                   ...
                                                   <input onchange='showTable("ProdResultSAMPLES","SAMPLES","Result")' id='search' type='text' name='search1' placeholder='Type anything..' class='form-control' style='font-size: 10px;'>
 
                                                    </td>
                                                    <td>&nbsp
                                                    <button type="button" onclick="showTable('ProdResultSAMPLES','SAMPLES','Result')" class="btn btn-outline-secondary p-0 my-2 my-sm-0">&nbsp<i class="fa fa-search"></i>&nbsp</button>  
                                                  </td>
                                                          ...
                                                          <div class="col-12">                                                          
                                                            <div class="btn-toolbar mb-1" role="toolbar" aria-label="Toolbar with button groups">
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                    ...
                                                                    <input onkeypress='showTable("ProdResultSAMPLES","SAMPLES","Result")' id='search' type='text' name='search1' placeholder='Type anything..' class='form-control' style='font-size: 10px;'>
                                                                    <div class="input-group-append" id="btnGroupAddon3">
                                                                    <button type="button" onclick='showTable("ProdResultSAMPLES","SAMPLES","Result")' class="btn btn-outline-secondary btn-export6 btn-sm" style="z-index:0">&nbsp<i class="fa fa-search"></i>&nbsp</button>    </div>
                                                                </div>
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                  ...
                                                                  <input id='sortfrom' onchange='showTable("ProdResultSAMPLES","SAMPLES","Result")' type='date' name='sortingdatefrom' class='form-control' style='font-size: 10px'>
                                                                </div>
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                  ...
                                                                  <input id='sortto' onchange='showTable("ProdResultSAMPLES","SAMPLES","Result")' type='date' name='sortingdateto' class='form-control' style='font-size: 10px'>
                                                                </div>
                                                                
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                    <div class="btn-group btn-group-sm">  
                                                                    <button type="button" onclick="cancelfilter('ProdResultSAMPLES','SAMPLES','Result')" class="btn btn-outline-secondary btn-export6"><i class="fas fa-ban"></i>&nbspCANCEL FILTER&nbsp&nbsp</button>  
                                                                     <button type="button" class="btn btn-outline-secondary btn-export6" onclick="SyncToProdOutputSystem();syncdatareload('ProdResultSAMPLES','SAMPLES','Result')" ><i class="fas fa-sync-alt"></i>&nbspSYNC&nbsp&nbsp</button>
                                                                    <button type="button" class="btn btn-outline-secondary btn-export6" onclick="exportxlsx('ProdResultSAMPLES','SAMPLES','Result')"><i class="fas fa-file-excel"></i>&nbspEXPORT&nbsp&nbsp</button>
                                                                </div>
                                                                &nbsp&nbsp&nbsp<span style="font-size: 16px; font-weight: bold"><h5>Prod Result SAMPLES</h5></span>
                                                                </div>
