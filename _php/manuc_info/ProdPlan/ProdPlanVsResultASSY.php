...
<div class="mod_options" style="z-index: 0;padding-top: 70px; padding-left: 15px">
                                                          ...
                                                          <div class="col-12">                                                          
                                                            <div class="btn-toolbar mb-1" role="toolbar" aria-label="Toolbar with button groups">
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                    ...
                                                                    <button type="button" class="btn btn-outline-secondary btn-export6" onclick="SyncToProdOutputSystem();syncdatareload('ProdPlanVsResultASSY','ASSY','PlanWithResult')" ><i class="fas fa-sync-alt"></i>&nbspSYNC&nbsp&nbsp</button>
  ...
  &nbsp<span style="font-size: 18px; font-weight: bold">Production Plan Vs Result ASSY</span>
