                                              ...
                                              <table style="width: 100%">
                                                <tr>
                                                  ...
                                                  <td> 
                                                    ...
                                                    <input onkeypress='showTable("ProdPlanVsResultPRINTING","PRINTING","PlanWithResult")' id='search' type='text' name='search1' placeholder='Type anything..' class='form-control' style='font-size: 10px;'>
                                                    ...
                                                    <td>&nbsp
                                                    <button type="button" onclick="showTable('ProdPlanVsResultPRINTING','PRINTING','PlanWithResult')" class="btn btn-outline-secondary p-0 my-2 my-sm-0 btn-export6">&nbsp<i class="fa fa-search"></i>&nbsp</button>  
                                                  </td>
                                                            ...
                                                            <div class="btn-toolbar mb-1" role="toolbar" aria-label="Toolbar with button groups">
                                                                ...
                                                                <div class="input-group btn-sm" style="height: 40px;">
                                                                    <div class="btn-group btn-group-sm">  
                                                                        ...
                                                                        <button type="button" class="btn btn-outline-secondary btn-export6" onclick="SyncToProdOutputSystem();cancelfilter('ProdPlanVsResultPRINTING','PRINTING','PlanWithResult')" ><i class="fas fa-sync-alt"></i>&nbspSYNC&nbsp&nbsp</button>
                                                                    ...
                                                                    &nbsp<span style="font-size: 15px; font-weight: bold">&nbsp&nbspProdPlan Vs Result PRINTING</span>
                                                                </div>
