    ...
    <div style="width: 100%;text-align: left;">
            ...
            <div class="row">
                                              ...
                                              <table style="width: 100%">
                                                <tr>
                                                  ...
                                                  <td> 
                                                    ...
                                                    <td>&nbsp
                                                    <button type="button" onclick="showTable('ProdPlanVsResultPRINTING','PRINTING','PlanWithResult')" class="btn btn-outline-secondary p-0 my-2 my-sm-0">&nbsp<i class="fa fa-search"></i>&nbsp</button>  
                                                  </td>
                                                      ...
                                                      <div class="row" style="padding-top: 10px;">
                                                          ...
                                                          <div class="col-xs-6 col-sm-3">
                                                            <!--    <table style="width: 100%">
                                                              ...
                                                              <button type="button" onclick="cancelfilter('ProdPlanVsResultPRINTING','PRINTING','PlanWithResult')" class="btn btn-outline-secondary"><i class="fas fa-ban"></i>&nbspCANCEL FILTER&nbsp&nbsp</button>  
                                                              <button type="button" class="btn btn-outline-secondary" onclick="SyncToProdOutputSystem();cancelfilter('ProdPlanVsResultPRINTING','PRINTING','PlanWithResult')" ><i class="fas fa-sync-alt"></i>&nbspSYNC&nbsp&nbsp</button>
                                                              <button type="button" class="btn btn-outline-secondary" onclick="exportxlsx('ProdPlanVsResultPRINTING','PRINTING','PlanWithResult')"><i class="fas fa-file-excel"></i>&nbspEXPORT&nbsp&nbsp</button>
                                                             </div>
                                      ...
                                      <div class="col-sm-3" style="padding-top: 15px; padding-right: 25px; text-align: right;">
                                       <span><h5>Prod Plan Vs Result PRINTING</h5></span>
                                    </div>
                          </div><!-- end of row-->
