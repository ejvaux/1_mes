...
include 'datavarPendingProduction.php';
?>
...
<div class="mod_menu" style="position: absolute">
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav nav-tabs mr-auto mt-1">                
              ...
              <li>
                <a class="nav-link active" id="menuhover" href="PendingProduction.php">Pending Production</a>
              </li>
              <li>
...
<div class="mod_options" style="z-index: 0;padding-top: 70px">
    ...
    <div style="width: 100%;text-align: left;">
          ...
          <form action='PendingProductionSort.php' method='POST' id="sortform">
            <div class="row">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;">
                                                          ...
                                                          <div class="col-xs-6 col-sm-3">
                                                            <!--    <table style="width: 100%">
                                                              ...
                                                              <a  class="btn btn-outline-secondary" href="/1_mes/_php/manuc_info/PendingProduction.php" >&nbsp&nbspCANCEL FILTER&nbsp&nbsp</a>
