...
include 'datavarProdplanVsResultSMT.php';
...
<div class="mod_options" style="z-index: 0;padding-top: 70px">
    ...
    <div style="width: 100%;text-align: left;">
              ...
              <form action='ProdPlanVsResultSMTSort.php' method='POST' id="sortform">
              <div class="row">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;">
                                                          ...
                                                          <div class="col-xs-6 col-sm-3">
                                                            <!--    <table style="width: 100%">
                                                              ...
                                                              <a class="btn btn-outline-secondary" href="/1_mes/_php/manuc_info/ProdPlanVsResultSMT.php">&nbsp&nbspCANCEL FILTER&nbsp&nbsp</a>
...
$("#download-csv").click(function(){
    $("#example-table").tabulator("download", "csv", "ProdplanVsResultSMT.csv");
});


//trigger download of data.xlsx file
$("#download-xlsx").click(function(){
    $("#example-table").tabulator("download", "xlsx", "ProdplanVsResultSMT.xlsx", {sheetName:"My Data"});
});

//trigger download of data.pdf file
$("#download-pdf").click(function(){
    $("#example-table").tabulator("download", "pdf", "ProdplanVsResultSMT.pdf", {
