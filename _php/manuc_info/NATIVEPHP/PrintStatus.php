...
include 'datavarPrintStatus.php';
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                              ...
                                              <?php
                                                  ...
                                                  echo " <input type='text' onchange='this.form.submit()' name='search1' placeholder='Type anything..' class='form-control' style='font-size: 10px;' value='" . $searchtext . "'>";
                             ...
                             <!--    <table style="width: 100%">
                                  <tr>
                                    ...
                                    <div class="btn-group btn-group-sm">
                                      <a class="btn btn-outline-secondary" href="/1_mes/_php/manuc_info/PrintStatus.php">&nbsp&nbspCANCEL FILTER&nbsp&nbsp</a>
                                      <a class="btn btn-outline-secondary" href="/1_mes/_php/manuc_info/CloningResults.php?address=PrintStatus.php">&nbsp&nbspSYNC&nbsp&nbsp</a>
...
$("#download-xlsx").click(function(){
    $("#example-table").tabulator("download", "xlsx", "PrintStatus.xlsx", {sheetName:"Print Status"});
});

//trigger download of data.pdf file
$("#download-pdf").click(function(){
    $("#example-table").tabulator("download", "pdf", "PrintStatus.pdf", {
