       ...
       <nav class="navbar navbar-brdr navbar-expand-lg navbar-light bg-light m-0 px-2 pb-1 pt-0" style="position:fixed;width: 100%; z-index:2; overflow:hidden;">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
          <ul class="navbar-nav nav-tabs mr-auto mt-1">                
              ...
              <li>
                <a class="nav-link tbl active" id="menuhover" href="/1_mes/_php/manuc_info/PendingProduction/PendingProduction.php">Pending Production</a>
              </li>
              <li>
                                                      ...
                                                      <div class="row" style="padding-top: 10px;">
                                                          ...
                                                          <div class="col-xs-6 col-sm-3">
                                                            <!--    <table style="width: 100%">
                                                              ...
                                                              <a class="btn btn-outline-secondary" href="/1_mes/_php/manuc_info/CloningResults.php?address=PendingProduction/PendingProduction.php">&nbsp&nbspSYNC&nbsp&nbsp</a>
...
function showUser(){
   ...
   /*  alert(strfromobj+" "+searchobj+" "+strtoobj); */
    ...
    $.ajax({
          method:'POST',
          url:'/1_mes/_php/manuc_info/PendingProduction/DataPendingProduction.php',
          data:
          {
              'sortfrom': strfromobj,
              'sortto': strtoobj,
