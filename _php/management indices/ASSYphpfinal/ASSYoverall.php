...
<tr align = 'center' ><strong>MACHINE LINE: $MACHINE_CODE </strong> <th width = '100px' style='position: absolute;
...
and mis_prod_plan_dl.DATE_ between '$from' and '$to'AND (mis_prod_plan_dl.MACHINE_CODE = 'S1' OR mis_prod_plan_dl.MACHINE_CODE = 'S2' OR mis_prod_plan_dl.MACHINE_CODE = 'S3') and (mis_prod_plan_dl.JOB_ORDER_NO LIKE '1%' OR mis_prod_plan_dl.JOB_ORDER_NO LIKE '5%')  group by mis_prod_plan_dl.DATE_")){
...
$tinput=0;
if($stmt = $conn1->query("SELECT SUM(mis_product.ACTUAL_QTY) FROM mis_product, mis_prod_plan_dl WHERE mis_product.JO_NUM = mis_prod_plan_dl.JOB_ORDER_NO AND mis_prod_plan_dl.DATE_ between '$from' and '$to' AND (mis_prod_plan_dl.MACHINE_CODE = 'S1' OR mis_prod_plan_dl.MACHINE_CODE = 'S2' OR mis_prod_plan_dl.MACHINE_CODE = 'S3') and (mis_prod_plan_dl.JOB_ORDER_NO LIKE '1%' OR mis_prod_plan_dl.JOB_ORDER_NO LIKE '5%')  group by mis_prod_plan_dl.DATE_")){
