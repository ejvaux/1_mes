...
<?php
 ...
 $i=$_POST['i'];
  ...
  $defect_id=$_POST['id'];
  $defect_id1=$_POST['id1'];
  $defect_id2=$_POST['id2'];
  $defect_id3=$_POST['id3'];
  $defect_id4=$_POST['id4'];
  $defect_id5=$_POST['id5'];
  $defect_id6=$_POST['id6'];
  $defect_id7=$_POST['id7'];
  $defect_id8=$_POST['id8'];
...
if($stmt = $connect->query("
  ...
  AND 1_smt.defect_mats.defect_id !='$defect_id3' 
  AND 1_smt.defect_mats.defect_id !='$defect_id4' 
