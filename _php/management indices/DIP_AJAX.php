...
{
include("DIPphpfinal/DIPoverall.php");
}
if($line==='OVERALL' && $shift==='1')
{
include("DIPphpfinal/DIPoverallday.php");
}

if($line==='OVERALL' && $shift==='2')
{
include("DIPphpfinal/DIPoverallnight.php");
}


include ("DIPphpfinal/DIPline/condition.php");
