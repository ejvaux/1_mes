...
<div class="container-fluid mt-5 ml-0 pl-0" id="table_display" style="width: 100%;" >
 ...
 <form id="contactForm1" method="POST" action="SAMPLESajax.php" style="margin-left: 10%;margin-right: 10%; position: fixed;
    display: flex;" >
<!--
...
<script type="text/javascript" src="MACHINE_CODEajax.js"></script>
<?php include("conn2.php");?>
      <?php 
      $sql = "SELECT MACHINE_GROUP FROM `dmc_machine_list` WHERE MACHINE_GROUP!='SMT'  AND MACHINE_GROUP!='PRINTING' AND MACHINE_GROUP!='ASSY'   GROUP BY MACHINE_GROUP ORDER BY MACHINE_GROUP DESC";
      $res = mysqli_query($conn1, $sql);
      if(mysqli_num_rows($res) > 0) {
        while($row = mysqli_fetch_object($res)) {
          echo "<option value='".$row->MACHINE_GROUP."'>".$row->MACHINE_GROUP."</option>";
        }
      }
      ?>
    </select>
  ...
  <div class="input-group-prepend" >
    <span class="input-group-text" >MACHINE LINE</span></div> 
...
<label><b>PRODUCTION SUMMARY OF <i>SAMPLES </i></b></label>
