...
if($stmt = $conn2->query("SELECT COUNT(created_at), updated_at FROM defect_mats WHERE division_id='2' AND created_at>='$start2' AND DATE_ADD(created_at, INTERVAL 0 DAY) <='$end2'  ")){
...
if($stmt = $conn2->query("SELECT date(created_at),COUNT(repaired_at) FROM defect_mats WHERE division_id='2' AND created_at>='$start1' AND DATE_ADD(created_at, INTERVAL 0 DAY) <='$end1' and repair='1'  ")){
...
if($stmt = $conn2->query("SELECT COUNT(repair), updated_at FROM defect_mats WHERE division_id='2' AND created_at>='$start' AND DATE_ADD(created_at, INTERVAL 0 DAY) <='$end' and repair='0'  ")){
...
if($stmt = $conn2->query("SELECT COUNT(created_at),count(repair) updated_at FROM defect_mats WHERE division_id='2' AND created_at>='$start3' AND DATE_ADD(created_at, INTERVAL 0 DAY) <='$end3'   ")){
