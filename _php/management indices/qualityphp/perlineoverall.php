...
if($stmt = $conn2->query("SELECT COUNT(created_at),count(repair) updated_at FROM defect_mats WHERE created_at>='$start3' AND DATE_ADD(created_at, INTERVAL 0 DAY) <='$end3' and line_id='$line_id'   ")){
