...
<div class="container-fluid mt-5 ml-0 pl-0" id="table_display" style="width: 100%;" >
 ...
 <form method="POST" style="margin-left: 1%; display: inline-flex;" >
...
<div class="input-group-prepend">
 ...
 <input class="btn btn-outline-primary" type="submit" value="DAILY" name="daily" width="15px" style=" width:100px; ">
