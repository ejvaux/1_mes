        ...
        <div class="form-group row">
          <div class="col-12">
              ...
              <div class="row">
                ...
                <div class="col-4">
                      <input type="text" list="jobOrder" class="form-control text-center" id="JobOrderNo"/>         
                  </div>
                <div class="col-2">
                      <label class="col-form-label-sm">Lot Number:</label></div>
                <div class="col-4">
                      <input type="text" class="form-control text-center" id="JobOrderNo" placeholder="not required.."/>    
